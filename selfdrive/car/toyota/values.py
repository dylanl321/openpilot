...
STATIC_MSGS = [
  ...
  (0x242, ECU.CAM, (CAR.CAMRY, CAR.CAMRYH, CAR.CHR, CAR.CHRH), 1,   5, '\x00\x10\x01\x00\x10\x01\x00'),
  (0x243, ECU.CAM, (CAR.CAMRY, CAR.CAMRYH, CAR.CHR, CAR.CHRH), 1,   5, '\x00\x10\x01\x00\x10\x01\x00'),
  ...
  (0x246, ECU.CAM, (CAR.CAMRY, CAR.CHR, CAR.CAMRYH, CAR.CHRH), 1, 5, '\x00\x10\x01\x00\x10\x01\x00'),
  (0x247, ECU.CAM, (CAR.CAMRY, CAR.CHR, CAR.CAMRYH, CAR.CHRH), 1, 5, '\x00\x10\x01\x00\x10\x01\x00'),
  ...
  (0x367, ECU.CAM, (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH, CAR.RAV4, CAR.COROLLA, CAR.HIGHLANDER, CAR.HIGHLANDERH, CAR.AVALON, CAR.CAMRY, CAR.CHR, CAR.CAMRYH, CAR.CHRH), 0,  40, '\x06\x00'),
  (0x414, ECU.CAM, (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH, CAR.RAV4, CAR.COROLLA, CAR.HIGHLANDER, CAR.HIGHLANDERH, CAR.AVALON, CAR.CAMRY, CAR.CHR, CAR.CAMRYH, CAR.CHRH), 0, 100, '\x00\x00\x00\x00\x00\x00\x17\x00'),
  ...
  (0x489, ECU.CAM, (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH, CAR.RAV4, CAR.COROLLA, CAR.HIGHLANDER, CAR.HIGHLANDERH, CAR.AVALON, CAR.CAMRY, CAR.CHR, CAR.CAMRYH, CAR.CHRH), 0, 100, '\x00\x00\x00\x00\x00\x00\x00'),
  (0x48a, ECU.CAM, (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH, CAR.RAV4, CAR.COROLLA, CAR.HIGHLANDER, CAR.HIGHLANDERH, CAR.AVALON, CAR.CAMRY, CAR.CHR, CAR.CAMRYH, CAR.CHRH), 0, 100, '\x00\x00\x00\x00\x00\x00\x00'),
  (0x48b, ECU.CAM, (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH, CAR.RAV4, CAR.COROLLA, CAR.HIGHLANDER, CAR.HIGHLANDERH, CAR.AVALON, CAR.CAMRY, CAR.CHR, CAR.CAMRYH, CAR.CHRH), 0, 100, '\x66\x06\x08\x0a\x02\x00\x00\x00'),
  (0x494, ECU.CAM, (CAR.CAMRY, CAR.CHR, CAR.CAMRYH, CAR.CHRH), 0, 100, '\x02\x00\x00\x00\x00\x00\x00'),
  (0x4d3, ECU.CAM, (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH, CAR.RAV4, CAR.COROLLA, CAR.AVALON, CAR.CAMRY, CAR.CHR, CAR.CAMRYH, CAR.CHRH), 0, 100, '\x1C\x00\x00\x01\x00\x00\x00\x00'),

  (0x128, ECU.DSU, (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH, CAR.RAV4, CAR.COROLLA, CAR.AVALON, CAR.CAMRY, CAR.CHR, CAR.CAMRYH, CAR.CHRH), 1,   3, '\xf4\x01\x90\x83\x00\x37'),
  ...
  (0x160, ECU.DSU, (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH, CAR.RAV4, CAR.COROLLA, CAR.HIGHLANDER, CAR.HIGHLANDERH, CAR.AVALON, CAR.SIENNA, CAR.CAMRY, CAR.CHR, CAR.CAMRYH, CAR.CHRH), 1,   7, '\x00\x00\x08\x12\x01\x31\x9c\x51'),
  ...
  (0x161, ECU.DSU, (CAR.CAMRY, CAR.CHR, CAR.CAMRYH, CAR.CHRH), 1, 7, '\x80\x1e\x00\xf3\x00\x08\x02'),
  (0x283, ECU.DSU, (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH, CAR.RAV4, CAR.COROLLA, CAR.HIGHLANDER, CAR.HIGHLANDERH, CAR.AVALON, CAR.SIENNA, CAR.CAMRY, CAR.CHR, CAR.CAMRYH, CAR.CHRH), 0,   3, '\x00\x00\x00\x00\x00\x00\x8c'),
  (0x2E6, ECU.DSU, (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH, CAR.CAMRY, CAR.CHR, CAR.CAMRYH, CAR.CHRH), 0,   3, '\xff\xf8\x00\x08\x7f\xe0\x00\x4e'),
  (0x2E7, ECU.DSU, (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH), 0,   3, '\xa8\x9c\x31\x9c\x00\x00\x00\x02'),
  (0x2E7, ECU.DSU, (CAR.CAMRY, CAR.CHR, CAR.CAMRYH, CAR.CHRH), 0, 3, '\x7d\x04\x00\x00\x00\x00\x00\x72'),
  (0x33E, ECU.DSU, (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH), 0,  20, '\x0f\xff\x26\x40\x00\x1f\x00'),
  (0x33E, ECU.DSU, (CAR.CAMRY, CAR.CHR, CAR.CAMRYH, CAR.CHRH), 0,  20, '\x0f\xff\x26\x80\x00\x1f\x00'),
  ...
  (0x344, ECU.DSU, (CAR.CAMRY, CAR.CHR, CAR.CAMRYH, CAR.CHRH), 0,  5, '\x00\x00\x00\x00\x00\x00\x00\x4f'), #very close to the one above.
  ...
  (0x365, ECU.DSU, (CAR.CAMRY, CAR.CHR, CAR.CAMRYH, CAR.CHRH), 0,  20, '\x00\x00\x00\x00\x0fc\x00\x00'),
  (0x366, ECU.DSU, (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH, CAR.HIGHLANDERH, CAR.CAMRY, CAR.CHR, CAR.CAMRYH, CAR.CHRH), 0,  20, '\x00\x00\x4d\x82\x40\x02\x00'),
  (0x366, ECU.DSU, (CAR.RAV4, CAR.COROLLA, CAR.HIGHLANDER, CAR.AVALON, CAR.SIENNA), 0,  20, '\x00\x72\x07\xff\x09\xfe\x00'),
  (0x440, ECU.DSU, (CAR.CAMRY, CAR.CHR, CAR.CAMRYH, CAR.CHRH), 1, 50, '\xff\x01\x63\x3d\x00\x00\x00\xec'),
  (0x441, ECU.DSU, (CAR.CAMRY, CAR.CHR, CAR.CAMRYH, CAR.CHRH), 1, 50, '\x7f\xff\x7f\xff\x00\x00\x00\x49'),
...
FINGERPRINTS = {
  ...
  #2019 XSE with telematics
  {
    36: 8, 37: 8, 170: 8, 180: 8, 186: 4, 426: 6, 452: 8, 464: 8, 466: 8, 467: 8, 513: 6, 544: 4, 550: 8, 552: 4, 562: 6, 608: 8, 610: 8, 705: 8, 728: 8, 761: 8, 764: 8, 800: 8, 810: 2, 812: 8, 818: 8, 824: 8, 865: 8, 889: 8, 896: 8, 898: 8, 900: 6, 902: 6, 905: 8, 921: 8, 933: 8, 934: 8, 935: 8,944: 8, 945: 8, 951: 8, 955: 8, 956: 8, 976: 1, 983: 8, 984: 8, 998: 5, 999: 7, 1000: 8, 1001: 8, 1002: 8, 1011: 8, 1014: 8, 1017: 8, 1020: 8, 1056: 8, 1059: 1, 1076: 8, 1077: 8, 1114: 8, 1164: 8, 1165: 8, 1166: 8, 1167: 8, 1237: 8, 1264: 8, 1279: 8, 1541: 8, 1552: 8, 1553: 8, 1556: 8, 1557: 8, 1568: 8, 1570: 8, 1571: 8, 1572: 8, 1592: 8, 1594: 8, 1595: 8, 1649: 8, 1745: 8, 1779: 8, 1786: 8, 1787: 8, 1788: 8, 1789: 8, 1904: 8, 1912: 8, 1990: 8, 1998: 8
  }],
  CAR.CAMRYH: [
...
DBC = {
  ...
  CAR.CHR: dbc_dict('toyota_nodsu_pt_generated', 'toyota_tss2_adas'),
  CAR.CHRH: dbc_dict('toyota_nodsu_hybrid_pt_generated', 'toyota_tss2_adas'),
  CAR.CAMRY: dbc_dict('toyota_nodsu_pt_generated', 'toyota_tss2_adas'),
  CAR.CAMRYH: dbc_dict('toyota_camry_hybrid_2018_pt_generated', 'toyota_tss2_adas'),
