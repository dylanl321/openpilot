...
_AWARENESS_TIME = 900.        # 1.5 minutes limit without user touching steering wheels make the car enter a terminal status
_AWARENESS_PRE_TIME_TILL_TERMINAL = 200.    # a first alert is issued 20s before expiration
_AWARENESS_PROMPT_TIME_TILL_TERMINAL = 50.  # a second alert is issued 5s before start decelerating the car
_DISTRACTED_TIME = 100.
_DISTRACTED_PRE_TIME_TILL_TERMINAL = 70.
_DISTRACTED_PROMPT_TIME_TILL_TERMINAL = 50.
